...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public int Insert_SubscribeUsers(string firstname, string lastname, string emailid, string phoneno, string message)
        {
            int result = 0;
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_AddSubscribers";
                cmd.Parameters.AddWithValue("@firstname", firstname);
                cmd.Parameters.AddWithValue("@lastname", lastname);
                cmd.Parameters.AddWithValue("@emailid", emailid);
                cmd.Parameters.AddWithValue("@phonenumber", phoneno);
