...
namespace Property.Admin
{
    public partial class Subscribers : System.Web.UI.Page
    {
        ...
        protected void FillGridData()
       {
        ...
        protected DataTable GetSubscribers()
        {
            ...
            try
            {
                ...
                string str = "select * from [tbl_Subscribers]";
                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "tbl_Subscribers";
            }
            catch (Exception ex)
            { }
            finally
        ...
        protected void grdUsers_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandArgument == "delete")
            {
                foreach (GridViewRow gvrow in grdUsers.Rows)
                {
                    ...
                    cmd.CommandText = "delete from  [dbo].[tbl_Subscribers] where user id ='" + ID + "'";
                }
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Delete from tbl_Subscribers where ID in(" + SelectedIds + ")", conn);
