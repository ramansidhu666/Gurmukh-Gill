...
namespace Property
{
    public partial class SubscribeInfo : System.Web.UI.UserControl
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            {
                cls_Property clsp = new cls_Property();
                clsp.Insert_SubscribeUsers(txtFirstName.Text, txtLastName.Text, txtEmail.Text, txtPhoneno.Text, txtMessage.Text + "<br/>" + HttpContext.Current.Request.Url.AbsoluteUri);
        ...
        public void SendMailToUser(string UserEmailId)
        {
            ...
            mail.To.Add(ToEmailID);
            mail.From = new MailAddress(FromEmailID);
            mail.Subject = "Gurmukh Gill";
            string body = "";
            body = "<p>Thanks for Subscribe.</p>";
            mail.Body = body;
