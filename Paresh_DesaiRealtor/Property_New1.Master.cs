    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesFaceBookShare()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fbProprtyUrl.Content = string.Format("http://www.gurmukhgill.com/PropertyDetails.aspx?MLSID={0}&PropertyType={1}", dt.Rows[0]["MLS"].ToString(), dt.Rows[0]["pType"].ToString());
                //fbProprtySiteName.Content = "";
